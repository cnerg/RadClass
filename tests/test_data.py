...
def create_file(live, timestamps, spectra):
    ...
    f.create_dataset(datapath + labels['live'], (timesteps,),
                     data=live, dtype='float64')
    f.create_dataset(datapath + labels['timestamps'], (timesteps,),
                     data=timestamps, dtype='float64')
    f.create_dataset(datapath + labels['spectra'], (timesteps, energy_bins),
